...
from ggbot.core.agent_loop import _extract_thinking_content
from ggbot.core.types import ChatMessage, ThinkingConfig
...
def test_thinking_event_in_transcript() -> None:
    ...
    thinking_event = {
        ...
        "type": "thinking",
        "data": {
            "content": "This is a thinking process",
            "content_len": 27,
        }
    }
    ...
    assert "content" in thinking_event["data"]
    ...
    assert loaded["data"]["content"] == "This is a thinking process"
