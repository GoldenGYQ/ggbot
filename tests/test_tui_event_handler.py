...
from ggbot.events.event_handlers.base_handler import BaseEventHandler
...
def test_tui_event_handler_static_methods():
    ...
    # 测试权限响应发布
    from ggbot.models.runtime_models import PermissionDecision
...
def test_tui_event_handler_cleanup():
    ...
    # 获取初始订阅数量
    from ggbot.events.event_bus import get_global_event_bus
