...
from ggbot.core.event_handlers.base_handler import BaseEventHandler, AgentState
from ggbot.core.event_bus import get_global_event_bus, publish_event
...
def test_create_base_event_handler():
    """测试创建基础事件处理器工厂函数"""
    from ggbot.core.event_handlers.base_handler import create_base_event_handler
