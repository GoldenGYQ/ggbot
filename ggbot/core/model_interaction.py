...
def perform_model_turn(
    *,
    ...
    try:
        ...
        events.append(runtime_event("provider_error", {"error": f"{type(e).__name__}: {e}"}))
        events.append(runtime_event("model_message", sys_msg.model_dump(exclude_none=True)))
    ...
    if thinking_enabled and final_content:
        ...
        if thinking_content:
            ...
            events.append(runtime_event("model_message", thinking_msg.model_dump(exclude_none=True)))
            events.append(
                runtime_event(
                    "thinking",
                    {
    ...
    events.append(runtime_event("model_message", assistant_msg.model_dump(exclude_none=True)))
