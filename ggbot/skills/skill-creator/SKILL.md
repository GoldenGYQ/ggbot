...
triggers: skill,skills,skill creator,skill-creator,create skill,update skill,SKILL.md,创建skill,新增skill,技能,技能创建,技能开发
---
...
For `ggbot`, workspace-level custom skills should live under the active workspace `skills/` directory so they can be discovered automatically at runtime (for example, `<workspace>/skills/my-skill/SKILL.md`).
